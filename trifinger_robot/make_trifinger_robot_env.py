...
def make_trifinger_robot_env(log_dir=None,base_seed= 0, frame_skip=0, allow_early_resets=False, visualization=False, 
                             initializer=None,difficulty=3,delta=0.1, action=False):
