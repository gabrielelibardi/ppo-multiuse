...
parser.add_argument(
    '--non-det', action='store_false', default=True, help='whether to use a non-deterministic policy')
parser.add_argument(
...
maker = make_trifinger_robot_env( log_dir = None, frame_skip=args.frame_skip, visualization=True)
