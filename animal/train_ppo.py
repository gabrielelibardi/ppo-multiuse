...
from ppo.algo.ppokl import ppo_rollout, ppo_update, ppo_save_model,ppo_rollout_2, ppo_rollout_old, ppo_rollout_mix, ppo_rollout_RND, ppo_rollout_imitate
...
def main():
    ...
    actor_critic = Policy(envs.observation_space,envs.action_space,base=CNN[args.cnn],
                            base_kwargs={'recurrent': args.recurrent_policy},rnd=args.RND )
